...
namespace Open_Water2.WebApi.Controllers
{
    ...
    public class TWQXActivityController : Controller
    {
        ...
        private IActionResult InsertOrUpdateWQX_ACTIVITY([FromQuery] global::System.Int32? aCTIVITY_IDX, global::System.String oRG_ID, global::System.Int32? pROJECT_IDX, global::System.Int32? mONLOC_IDX, global::System.String aCTIVITY_ID,
            ...
            string thermalPreservativeUsedName, string hydrologicCondition, string sampContLabName, string hydrologicEvent,
            ...
            String cREATE_USER = "system", string eNTRY_TYPE = "C")
        {
            ...
            dEPTH_REF_POINT,  aCT_COMMENT,  bIO_ASSEMBLAGE_SAMPLED,  bIO_DURATION_MSR,
             ...
             sAMP_PREP_STORAGE_DESC,  wQX_SUBMIT_STATUS, aCT_IND, wQX_IND,
             activityIDUserSupplied, sampCompName, activityLocDescText,
             measureValue, gearProcUnitSelected, habitatSelMethod, methodName,
