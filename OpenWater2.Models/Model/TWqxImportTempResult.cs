...
{
    public partial class TWqxImportTempResult
    {
        ...
        public string LabSampPrepId { get; set; }
        public string LabSampPrepCtx { get; set; }
        ...
        public virtual TWqxImportTempSample TempSampleIdxNavigation { get; set; }
    }
}
